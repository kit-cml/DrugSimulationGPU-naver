...
"./drug_sim" -input_deck ./input_deck2.txt -hill_file ./drugs/$drugname/IC50_samples10k.csv
...
"./drug_sim" -input_deck ./input_deck2.txt -hill_file ./drugs/$drugname/IC50_samples10k.csv -init_file ./result/$formatted_concentration.csv
new_value="0"
sed -i.old "s/^\(Is_Post_Processing = \).*/\1$new_value/" "./input_deck2.txt"
